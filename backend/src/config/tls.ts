...
export interface TLSConfig {
  ...
  ciphers?: string; // Allowed cipher suites (comma-separated)
  honorCipherOrder: boolean; // Honor server cipher order
  dhparam?: string; // Diffie-Hellman parameters
  ecdhCurve?: string; // ECDH curves
 ...
 */
export function getSecureCiphers(): string {
  return defaultTLSConfig.ciphers || [
 ...
 */
export function getHSTSHeader(config: TLSConfig): string {
 ...
 */
export function getTLSEnvironmentVariables(): Record<string, string> {
  return {
